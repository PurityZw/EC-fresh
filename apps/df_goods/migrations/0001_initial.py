    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(verbose_name='商品', to='df_goods.GoodsSKU')),
            ],
            options={
                'verbose_name': '首页轮播商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.SmallIntegerField(verbose_name='展示顺序', default=0)),
                ('sku', models.ForeignKey(verbose_name='商品SKU', to='df_goods.GoodsSKU')),
                ('type', models.ForeignKey(verbose_name='商品类型', to='df_goods.GoodsType')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='goodssku',
            name='type',
            field=models.ForeignKey(verbose_name='商品种类', to='df_goods.GoodsType'),
        ),
        migrations.AddField(
